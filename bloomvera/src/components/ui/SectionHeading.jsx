  ...
  return (
    <div className={`mb-14 ${center ? "text-center" : ""}`}>
      ...
      <motion.h2
        ...
        className={`font-sans font-bold leading-tight tracking-tight ${light ? "text-white" : "text-dark"}`}
      ...
      {subtitle && (
        <motion.p
          ...
          className={`mt-4 text-base leading-relaxed max-w-2xl ${center ? "mx-auto" : ""} ${light ? "text-gray-400" : "text-muted"}`}
        >
          {subtitle}
        </motion.p>
      )}
